...
_graph = new (function () {
    ...
    function draw() {
        ...
        ctx.fillRect(
            0,
            0,
            graph.defaultsetings.canvasWidth,
            graph.defaultsetings.canvasHeight,
        );
        ...
        for (var i = 0; i < graph.data.data.length; i++) {
            ...
            drawColumn(
                ...
                t,
                graph.col.width,
                graph.data.data[i][1] * graph.col.ratio,
                graph.col.margin,
                i,
                graph.defaultsetings.threeD,
            );
            ...
            setText(
                ...
                t,
                graph.col.width,
                graph.data.data[i][1] < graph.data.max / 2,
                1,
            );
            setText(
                graph.data.data[i][0],
        ...
        if (graph.defaultsetings.title !== '') {
            ...
            ctx.fillText(
                graph.defaultsetings.title,
                graph.defaultsetings.canvasWidth / 2,
                graph.defaultsetings.margin,
            );
        }
    }
...
HTMLCanvasElement.prototype.graph = function (data, setting) {
    _graph.init(this, data, setting);
};
