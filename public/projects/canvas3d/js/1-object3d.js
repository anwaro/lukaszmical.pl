...
function Vertex(x, y, z) {
    ...
    this.crossProduct = function (vertex) {
        return new Vertex(
            this.y * vertex.z - vertex.y * this.z,
...
function Matrix(v1, v2, v3) {
    ...
    this.dotProduct = function (vertex) {
        this.result.x =
            this.v1.x * vertex.x + this.v1.y * vertex.y + this.v1.z * vertex.z;
        this.result.y =
            this.v2.x * vertex.x + this.v2.y * vertex.y + this.v2.z * vertex.z;
        this.result.z =
            this.v3.x * vertex.x + this.v3.y * vertex.y + this.v3.z * vertex.z;
        return this.result;
    };
