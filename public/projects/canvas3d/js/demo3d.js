...
function rotate() {
    ...
    rotateAxis.set(
        mouseLazy.x - canvasSetting.width / 2,
        canvasSetting.height / 2 - mouseLazy.y,
    );
    window.canvas3d.strokeLine(
        [rotateAxis.multiply(0), rotateAxis.multiply(1 / sceneConfig.scale)],
        axisSetting,
    );
