var colorPicker = {
    ...
    getColor: function (o) {
        var c = colorPicker.canvas.getBoundingClientRect(),
            e = o.clientX - c.left,
            r = o.clientY - c.top,
            i = colorPicker.ctx.getImageData(e, r, 1, 1).data;
        (colorPicker.colorRgba =
            'rgba(' + i[0] + ',' + i[1] + ',' + i[2] + ',' + i[3] / 255 + ')'),
            (colorPicker.colorRgbaObj = {r: i[0], g: i[1], b: i[2], a: i[3] / 255}),
